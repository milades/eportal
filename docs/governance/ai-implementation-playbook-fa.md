...
در وضعیت جاری پروژه، `P0.1` با مرجع `APP-P0.1-001` پذیرفته شده و
`P0.2` در حالت `Active/Draft` است. اقدام مجاز فعلی فقط تکمیل ورودی‌ها،
رفع ابهام‌ها و تأیید بسته اجرایی P0.2 است؛ تا ثبت Execution Approval برای
P0.2 هیچ تغییر زیرساختی یا کدنویسی Production-grade مجاز نیست.
